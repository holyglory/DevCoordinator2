...
- **REQ-EVENT-01** (2026-09-04, in scope): `event.wait` is one generated protocol-v2
  ...
  3339 deadline.
- **REQ-EVENT-02** (2026-09-04, in scope): One durable schema-16 SQLite journal
...
- **REQ-EVENT-03** (2026-09-04, in scope): One scheduler owns every subscription
...
- **REQ-EVENT-04** (2026-09-04, in scope): Cursor capture and scheduler registration
...
- **REQ-EVENT-05** (2026-09-04, in scope): Every scheduler wake reauthorizes the
...
- **REQ-EVENT-06** (2026-09-04, in scope): Native test lifecycle, deployment,
